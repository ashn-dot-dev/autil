...
#ifndef PERF_BIGINT_ADD_H_INCLUDED
#define PERF_BIGINT_ADD_H_INCLUDED

#include "perf.h"

static void
measure_bigint_add(char const* file, char const* lhs_cstr, char const* rhs_cstr)
{
...
#endif // PERF_BIGINT_ADD_H_INCLUDED
